...
const EXPECTED_PORTFOLIO_LABS = readPositiveInteger("SMOKE_EXPECTED_PORTFOLIO_LABS", "EXPECTED_PORTFOLIO_LABS", 7);
...
async function assertPortfolioLabUi(page, portfolioLabs) {
  ...
  await expect(page.getByRole("heading", { name: "Review Kubernetes YAML before apply", exact: true })).toHaveCount(0);
