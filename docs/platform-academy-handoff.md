...
- Lab review matrix: `make platform-lab-matrix` prints portfolio focus and structural-gate columns so reviewers can route the seventeen portfolio-grade labs separately from the broader full-lab set.
