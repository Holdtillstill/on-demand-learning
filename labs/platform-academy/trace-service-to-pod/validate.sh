...
grep -q "EndpointSlice" "$TRIAGE" || fail "triage-notes.md should include EndpointSlice evidence"
grep -q "source manifest" "$TRIAGE" || fail "triage-notes.md should include source manifest handoff evidence"
...
if [[ -n "$evidence_file" ]]; then
  ...
  require_evidence_match "$evidence_file" "triage notes and false leads" "triage-notes\\.md|triage notes|False Leads|false leads|false lead"
