...
usage() {
  cat <<'EOF'
Usage:
  bash labs/platform-academy/create-platform-golden-path/setup.sh [--no-cluster] [--evidence <file>]

Options:
  --no-cluster   Prepare the local Evidence note and run the captured golden-path analyzer. This is the default.
