...
- The triage notes rule out using lab count as proof, writing duty-only resume bullets, telling STAR stories without decisions or validation, and publishing unredacted evidence.
...
- The README template forces a stronger story than a generic project summary because it includes problem, environment, commands, decision, validation, rollback, and interview talking points.
