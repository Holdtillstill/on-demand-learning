...
- Browser smoke: 21 courses, 84 lessons, 21 lab detail routes, 21 portfolio-grade UI signals, 330 resource detail routes, 29 interview prep packs, desktop and mobile route checks.
