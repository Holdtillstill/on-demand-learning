...
- Browser smoke: 21 courses, 84 lessons, 21 lab detail routes, 12 portfolio-grade UI signals, 320 resource detail routes, 22 interview prep packs, desktop and mobile route checks.
