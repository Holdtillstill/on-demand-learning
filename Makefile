...
release-check: fmt-check doc-link-check env-contract-check platform-content-count-check working-tree-hygiene-check script-syntax-check smoke-helper-check api-migration-check test compose-config k8s-platform-contract kubeconform-check workflow-lint ## Run local release gates before tagging or publishing images
